...
final class UpdateContactRequest implements UseCaseRequestInterface
{
    private const HTTP_METHOD = Request::METHOD_PATCH;

    private const ENDPOINT = 'Contacts';

    private const RESPONSE_CLASS = UpdateContactResponse::class;
